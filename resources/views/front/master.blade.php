...
<div class="wrapper ovh">
    ...
    <nav class="posr">
      <div class="container maxw1600 posr menu_bdrt1">
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-auto">
            <a class="header-logo" href="index.html"><img src="{{asset('theme/images/header-logo3.svg')}}" alt="Header Logo"></a>
          </div>
          <div class="col-auto">
      ...
      <div class="header innerpage-style">
        <div class="menu_and_widgets">
          <div class="mobile_menu_bar d-flex justify-content-between align-items-center">
            <a class="menubar" href="#menu"><img src="{{asset('theme/images/mobile-dark-nav-icon.svg')}}" alt=""></a>
            <a class="mobile_logo" href="#"><img src="{{asset('theme/images/header-logo2.svg')}}" alt=""></a>
  ...
  <div class="body_content">
          ...
          <div class="row align-items-center">
            <div class="col-xl-6">
              <div class="inner-banner-style7 mb30-lg">
                <h2 class="hero-title mb30 animate-up-1">Discover a place you'll <br class="d-none d-lg-block"> love to live</h2>
    ...
    <!-- Our Partners -->
    <section class="our-partners bgc-white pt60">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="dots_none nav_none slider-dib-sm slider-6-grid owl-carousel owl-theme wow fadeInUp" data-wow-delay="300ms">
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{asset('theme/images/partners/1.png')}}" alt="1.png')}}"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{asset('theme/images/partners/2.png')}}" alt="2.png')}}"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{asset('theme/images/partners/3.png')}}" alt="3.png')}}"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{asset('theme/images/partners/4.png')}}" alt="4.png')}}"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{asset('theme/images/partners/5.png')}}" alt="5.png')}}"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{asset('theme/images/partners/6.png')}}" alt="6.png')}}"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-6">
            <div class="dark-light-navtab style2 text-start text-lg-end mt-0 mt-lg-4 mb-4">
              <ul class="nav nav-pills justify-content-start justify-content-lg-end" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link rounded-0 mb10-sm active" id="pills-house-tab" data-bs-toggle="pill" data-bs-target="#pills-house" type="button" role="tab" aria-controls="pills-house" aria-selected="true">For Rent</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <div class="row">
                  <div class="col-sm-6 col-lg-4">
                    <div class="listing-style8">
                      <div class="list-thumb">
                        <img class="w-100" src="{{asset('theme/images/listings/g1-1.jpg')}}" alt="">
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <div class="listing-style8">
                      <div class="list-thumb">
                        <img class="w-100" src="{{asset('theme/images/listings/g1-2.jpg')}}" alt="">
                        <div class="list-meta">
                          <a class="rounded-0" href="#"><span class="flaticon-like"></span></a>
                          <a class="rounded-0" href="#"><span class="flaticon-new-tab"></span></a>
                          <a class="rounded-0" href="#"><span class="flaticon-fullscreen"></span></a>
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <div class="listing-style8">
                      <div class="list-thumb">
                        <img class="w-100" src="{{asset('theme/images/listings/g1-3.jpg')}}" alt="">
                        <div class="list-meta">
                          <a class="rounded-0" href="#"><span class="flaticon-like"></span></a>
                          <a class="rounded-0" href="#"><span class="flaticon-new-tab"></span></a>
                          <a class="rounded-0" href="#"><span class="flaticon-fullscreen"></span></a>
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <div class="listing-style8">
                      <div class="list-thumb">
                        <img class="w-100" src="{{asset('theme/images/listings/g1-4.jpg')}}" alt="">
                        <div class="list-tag rounded-0 fz12"><span class="flaticon-electricity me-2"></span>FEATURED</div>
                        <div class="list-meta">
                          <a class="rounded-0" href="#"><span class="flaticon-like"></span></a>
                          <a class="rounded-0" href="#"><span class="flaticon-new-tab"></span></a>
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <div class="listing-style8">
                      <div class="list-thumb">
                        <img class="w-100" src="{{asset('theme/images/listings/g1-5.jpg')}}" alt="">
                        <div class="list-tag rounded-0 fz12"><span class="flaticon-electricity me-2"></span>FEATURED</div>
                        <div class="list-meta">
                          <a class="rounded-0" href="#"><span class="flaticon-like"></span></a>
                          <a class="rounded-0" href="#"><span class="flaticon-new-tab"></span></a>
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <div class="listing-style8">
                      <div class="list-thumb">
                        <img class="w-100" src="{{asset('theme/images/listings/g1-6.jpg')}}" alt="">
                        <div class="list-meta">
                          <a class="rounded-0" href="#"><span class="flaticon-like"></span></a>
                          <a class="rounded-0" href="#"><span class="flaticon-new-tab"></span></a>
                          <a class="rounded-0" href="#"><span class="flaticon-fullscreen"></span></a>
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
          <div class="col-lg-6">
            <div class="feature-style1 bdrs0 mb30">
              <div class="feature-img"><img class="w-100" src="{{asset('theme/images/listings/city-listing-2.jpg')}}" alt=""></div>
          ...
          <div class="col-6 col-lg-3">
            <div class="feature-style1 bdrs0 mb30">
              <div class="feature-img"><img class="w-100" src="{{asset('theme/images/listings/city-listing-3.jpg')}}" alt=""></div>
              <div class="feature-content">
                <div class="top-area">
          ...
          <div class="col-6 col-lg-3">
            <div class="feature-style1 bdrs0 mb30">
              <div class="feature-img"><img class="w-100" src="{{asset('theme/images/listings/city-listing-4.jpg')}}" alt=""></div>
              <div class="feature-content">
                <div class="top-area">
          ...
          <div class="col-6 col-lg-3">
            <div class="feature-style1 bdrs0 mb30">
              <div class="feature-img"><img class="w-100" src="{{asset('theme/images/listings/city-listing-5.jpg')}}" alt=""></div>
              <div class="feature-content">
                <div class="top-area">
          ...
          <div class="col-6 col-lg-3">
            <div class="feature-style1 bdrs0 mb30">
              <div class="feature-img"><img class="w-100" src="{{asset('theme/images/listings/city-listing-6.jpg')}}" alt=""></div>
              <div class="feature-content">
                <div class="top-area">
          ...
          <div class="col-lg-6">
            <div class="feature-style1 bdrs0 mb30">
              <div class="feature-img"><img class="w-100" src="{{asset('theme/images/listings/city-listing-7.jpg')}}" alt=""></div>
              <div class="feature-content">
                <div class="top-area">
    ...
    <section class="bgc-thm-light pb90 pb30-md">
      <img class="funfact-floating-img1 wow zoomIn d-none d-lg-block" src="{{asset('theme/images/resource/h7-bg-1.png')}}" alt="">
      <img class="funfact-floating-img2 wow zoomIn d-none d-lg-block" src="{{asset('theme/images/resource/h7-bg-2.png')}}" alt="">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 col-xl-5 wow fadeInRight" data-wow-delay="100ms">
            <div class="cta-style6 mb30-sm">
              ...
              <a href="page-contact.html" class="ud-btn btn-dark bdrs0">Get Started <i class="fal fa-arrow-right-long"></i></a>
            </div>
          </div>
